...
const Home = () => {
    ...
    return (
        <div className='img'>
            <div>
                <h1 className='text-center text-white text-3xl p-10 '>The executive chef is the head of the kitchen and is responsible for managing all aspects of the kitchen, including menu creation, <span className='text-yellow-300'>recipe development</span>, <span className='text-pink-500'>food preparation</span>, kitchen staff supervision, and <span className='text-blue-600 font-bold font-mono text-4xl'>food safety and sanitation.</span></h1>
            </div>
